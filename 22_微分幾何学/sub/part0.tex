...
\begin{definition}[被覆空間]
    ...
    $\pi$ (あるいは$E$) が$M$の
    \term{被覆空間}[covering space]{ひふくくうかん}
    であるとは、
    各$p \in M$に対し、
...
\begin{proposition}[位相的被覆空間は{\smooth}被覆空間]
    $M$を多様体、
...
\begin{definition}[部分多様体]
    ...
    $S$が$M$の
    \term{はめ込み部分多様体}[immersed submanifold]
    ...
    $S$は$M$の
    \term{埋め込み部分多様体}[embedded submanifold]
...
\begin{proposition}[はめ込みの像は部分多様体]
    \TODO{cf. \url{https://math.stackexchange.com/a/3254739}}
\end{proposition}
...
\begin{proposition}[Lie 微分と $t$-微分]
...
\begin{definition}[微分形式]
    \idxsym{space of smooth $s$-forms}{$\Omega^s(U)$}{$U$上の{\smooth} $s$-形式全体の空間}
    $M$を$m$次元多様体、
    $U \opensubset M$とする。
    \begin{itemize}
...
\begin{proposition}[外積の基本性質]
    ...
    $M$を多様体、$U \opensubset M$とする。
    \begin{enumerate}
        \item $U$上の$r$-形式$\omega$と$s$-形式$\mu$に対し、
            \begin{equation}
                \omega \wedge \eta = (-1)^{rs} \eta \wedge \omega
            \end{equation}
            が成り立つ。
        \item $U$上の1-形式$\omega_1, \dots, \omega_k$に対し、
            \begin{equation}
...
\begin{proposition}[最高次形式の引き戻し公式]
    ...
    $M, N$を$n$次元多様体、
    $F \colon M \to N$を{\smooth}写像、
    $(x^i), (y^j)$をそれぞれ$U \opensubset M, V \opensubset N$上の座標とする。
    ...
    \begin{equation}
        F^* (u \,dy^1 \wedge \dots \wedge dy^n)
            =
                (u \circ F)
                \det \frac{\del (y^1 \circ F, \dots, y^n \circ F)}{\del (x^1, \dots, x^n)}
